...
const writeAPIDocumentationFiles = async (dest: string, methods: DeclarationReflection[], definitions: Definitions) => {
...
const writeIndexFile = async (dest: string, methods: DeclarationReflection[]) => {
  const contents = [
    '# API',
    '',
