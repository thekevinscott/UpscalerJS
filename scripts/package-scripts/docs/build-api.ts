...
const EXTERNALLY_DEFINED_TYPES: Record<string, TypedocDeclarationReflection> = {
...
// const writeParameter = (methodName: string, parameter: ParameterReflection | TypedocDeclarationReflection, matchingType: undefined | DecRef | TypeParameterReflection, definitions: Definitions, childParameters: string) => {
...
// const writePlatformSpecificParameter = (platform: string, parameter: TypedocDeclarationReflection, definitions: Definitions) => {
//   const comment = getSummary(parameter.comment);
//   const { type, name } = getReferenceTypeOfParameter(parameter.type, definitions);
...
// const getMatchingType = (parameter: ParameterReflection | TypedocDeclarationReflection, definitions: Definitions, typeParameters: Record<string, TypeParameterReflection> = {}) => {
...
//   let matchingType: undefined | PlatformSpecificDeclarationReflection | TypedocDeclarationReflection | TypeParameterReflection = undefined;
...
// const getParameters = (methodName: string, parameters: (ParameterReflection | TypedocDeclarationReflection)[], definitions: Definitions, typeParameters: Record<string, TypeParameterReflection> = {}, depth = 0): string => {
//   if (depth > 5) {
