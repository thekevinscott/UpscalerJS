...
MAXIM Retouching is a collection of models for retouching images.
...
- medium: `@upscalerjs/maxim-retouching/medium` - quantized `float16`, input size of 256
...
```
import Upscaler from 'upscaler';
import models from '@upscalerjs/maxim-retouching';
