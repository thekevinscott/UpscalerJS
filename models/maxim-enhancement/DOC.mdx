...
hide_title: true
enhanced_src: maxim-enhancement/result.png
...
<ModelHeaderImage packageName="maxim-enhancement" unenhancedSrc="maxim-enhancement/fixture.png" enhancedSrc="maxim-enhancement/result.png" oversized />

# MAXIM Enhancement

<Badges packageName="maxim-enhancement" />
...
![Original unenhanced image](/assets/sample-images/maxim-enhancement/fixture.png)

_Enhanced_

![Enhanced image](/assets/sample-images/maxim-enhancement/result.png)
...
```
<script src="https://cdn.jsdelivr.net/npm/@upscalerjs/maxim-enhancement@latest/dist/umd/index.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/upscaler@latest/dist/browser/umd/upscaler.min.js"></script>

<script type="text/javascript">
  const upscaler = new Upscaler({
    model: UpscalerJSMaximEnhancement,
  })
</script>
```
...
const model = require('@upscalerjs/maxim-enhancement');
