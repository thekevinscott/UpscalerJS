...
These models are the fastest available ESRGAN models.
...
<iframe height="400" width="100%" src="https://stackblitz.com/github/thekevinscott/upscalerjs/tree/main/models/esrgan-slim/demo?file=index.js&title=@upscalerjs/esrgan-slim"></iframe>
...
## Goals for the model
ESRGAN Slim is meant to be the fastest available ESRGAN model, fast enough to run in a browser.
