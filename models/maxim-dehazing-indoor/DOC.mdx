...
hide_title: true
enhanced_src: maxim-dehazing-indoor/result.png
category: dehazing
---
...
<ModelHeaderImage packageName="maxim-dehazing-indoor" unenhancedSrc="maxim-dehazing-indoor/fixture.png" enhancedSrc="maxim-dehazing-indoor/result.png" oversized />

# MAXIM Dehazing Indoor

<Badges packageName="maxim-dehazing-indoor" />
...
![Original unenhanced image](/assets/sample-images/maxim-dehazing-indoor/fixture.png)

_Enhanced_

![Enhanced image](/assets/sample-images/maxim-dehazing-indoor/result.png)
...
```
<script src="https://cdn.jsdelivr.net/npm/@upscalerjs/maxim-dehazing-indoor@latest/dist/umd/index.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/upscaler@latest/dist/browser/umd/upscaler.min.js"></script>

<script type="text/javascript">
  const upscaler = new Upscaler({
    model: UpscalerJSMaximDehazingIndoor,
  })
</script>
```
...
const model = require('@upscalerjs/maxim-dehazing-indoor');
