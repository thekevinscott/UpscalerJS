...
hide_title: true
enhanced_src: maxim-deblurring/result.png
category: deblurring
---
...
<ModelHeaderImage packageName="maxim-deblurring" unenhancedSrc="maxim-deblurring/fixture.png" enhancedSrc="maxim-deblurring/result.png" oversized />

# MAXIM Deblurring

<Badges packageName="maxim-deblurring" />
...
![Original unenhanced image](/assets/sample-images/maxim-deblurring/fixture.png)

_Enhanced_

![Enhanced image](/assets/sample-images/maxim-deblurring/result.png)
...
```
<script src="https://cdn.jsdelivr.net/npm/@upscalerjs/maxim-deblurring@latest/dist/umd/index.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/upscaler@latest/dist/browser/umd/upscaler.min.js"></script>

<script type="text/javascript">
  const upscaler = new Upscaler({
    model: UpscalerJSMaximDeblurring,
  })
</script>
```
