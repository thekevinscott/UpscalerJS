...
description: Overview of @upscalerjs/maxim-deraining model
sidebar_position: 14
sidebar_label: maxim-deraining
hide_title: true
enhanced_src: maxim-deraining/result.png
category: deraining
---
...
<ModelHeaderImage packageName="maxim-deraining" unenhancedSrc="maxim-deraining/fixture.png" enhancedSrc="maxim-deraining/result.png" oversized />

# MAXIM Deraining

<Badges packageName="maxim-deraining" />
...
![Original unenhanced image](/assets/sample-images/maxim-deraining/fixture.png)

_Enhanced_

![Enhanced image](/assets/sample-images/maxim-deraining/result.png)

## Demo

import ModelExample from '@site/src/components/modelExample/modelExample';

<ModelExample model="maxim-deraining" />
...
```
<script src="https://cdn.jsdelivr.net/npm/@upscalerjs/maxim-deraining@latest/dist/umd/index.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/upscaler@latest/dist/browser/umd/upscaler.min.js"></script>

<script type="text/javascript">
  const upscaler = new Upscaler({
    model: UpscalerJSMaximDeraining,
  })
</script>
```
