...
exports.getTensorDimensions = function (row, col, patchSize, padding, height, width) {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    originalSize = exports.getTensorDimensions(0, 0, patchSize, padding, height, width).size;
                ...
                case 2:
                    ...
                    _e = exports.getTensorDimensions(row, col, patchSize, padding, height, width), origin_1 = _e.origin, size = _e.size, sliceOrigin = _e.sliceOrigin, sliceSize = _e.sliceSize;
